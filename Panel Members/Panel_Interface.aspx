<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Panel_Interface.aspx.cs" Inherits="Panel_Members_Panel_Interface" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Panel Inteface</title>
    <style>
        body {
    ...
    <form id="form1" runat="server" class="form-wrap">
        ...
        <p>
            ...
            Choose the action  <asp:DropDownList ID="DropDownList1" runat="server" class="select" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
                ...
                <asp:ListItem>Evaluate Group</asp:ListItem>
            </asp:DropDownList>
            <br><br> 
